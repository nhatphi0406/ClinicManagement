...
CREATE TABLE `prescription` (
  ...
  `created_date` datetime NOT NULL,
  `resul` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `avata` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user` VALUES (1,'nhat','phi','nhatphi@gmail.com',NULL,'nhatphi','$2a$10$5X9k5N1sTc1/CjVH5XJoje3QMYijH3ETpgkox00R0MdPaJPPrf7wO',_binary '','ROLE_ADMIN',NULL),(2,'nguyen','quynh','nguyenquynh@gmail.com',NULL,'nguyenquynh','$2a$10$5X9k5N1sTc1/CjVH5XJoje3QMYijH3ETpgkox00R0MdPaJPPrf7wO',_binary '','ROLE_USER',NULL),(10,'doan','ket','doanket@gmail.com','123456789','doanket','$2a$10$D.spMVV/oINa5H5GsTy0COB.1O5VT3qgMMVtm89XCBSyhu6VgtXjm',NULL,'ROLE_DOCTOR',NULL);
...
-- Dump completed on 2022-08-13 21:30:00
